...
`@vault-ledger/server` is the localhost review bridge that `ledger serve` starts, letting a human review and approve pending agent-proposed changes before they land in the vault.
